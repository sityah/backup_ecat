            ...
            if (isset($_POST["simpan-cs"])) {
                ...
                if ($result_perusahaan) {
                    ...
                    $query_insert = "INSERT INTO tb_customer
                                        (id_customer, nama_contact_person, id_perusahaan, no_npwp_instansi, no_telp_cs, email_cs, status_cs, created_date) 
                                        VALUES ('$id_customer', '$nama_cp', '$id_perusahaan', '$npwp', '$telp', '$email', '$status_cs', '$created_date')";
