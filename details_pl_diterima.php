...
<body>
                                ...
                                <?php
                                    ...
                                    if (isset($_GET['id_inv_pl'])) {
                                        ...
                                        $sql = "SELECT
                                                ...
                                                LEFT JOIN
                                                    mandir36_db_ecat_staging.tb_spk_pl ON inv_pl.id_inv_pl = tb_spk_pl.id_inv_pl -- Menggunakan id_inv_pl dari inv_pl
                                                LEFT JOIN
    ...
    <div class="modal fade" id="uploadModal" tabindex="-1" aria-labelledby="konfirmasiModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
            <form id="insertForm" method="post" action="proses/proses_transaksi_pl_selesai.php" enctype="multipart/form-data">
                <input type="hidden" name="id_inv_pl" value="<?php echo $id_inv_pl; ?>">
                <div class="modal-header">
