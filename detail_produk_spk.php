...
<body>
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card mb-4 p-2">
                            ...
                            <form id="insertForm" method="post" action="proses/proses_pesanan.php">
                                <input type="hidden" name="id_spk_ecat" value="<?php echo $spkId; ?>">
                                <div class="card-body border mt-2 mb-4">
                                    <div class="row mb-4">
                                        <div class="table-responsive">
                                            <button type="button" class="btn btn-primary mb-3" onclick="window.location.href = 'data_spk.php';"><i class="tf-icons bx bxs-chevrons-left"></i> Kembali</button>
                                            ...
                                            <?php
                                                ...
                                                $query_check = "SELECT 
                                                                    ...
                                                                    sr.status_cetak,
                                                                    tps.status_tmp
                                                                FROM tb_spk_ecat AS sr
                                                                JOIN tmp_produk_spk_ecat AS tps ON sr.id_spk_ecat = tps.id_spk_ecat
                                            ...
                                            ?>
                                                    ...
                                                    <button type="button" class="btn btn-outline-primary mb-3" id="btnProsesPesanan" data-spkid="<?php echo $spkId; ?>" data-bs-toggle="modal" data-bs-target="#konfirmasiModal">Proses Pesanan</button>
                                            <?php
                                                }
                                                mysqli_close($koneksi);
                                            ?>
                                                    ...
                                                    <?php
                                                        ...
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                            ...
                                                            echo "<td>
                                                                    ...
                                                                    <button type='button' class='btn btn-danger btn-sm mt-2 btn-delete' data-id='" . $row['id_tmp_ecat'] . "' data-nama='" . $row['nama_produk'] . "'>
                            ...
                            <form id="updateQtyForm" method="post" action="update_qty.php">
                                <input type="hidden" name="id_spk_ecat" value="<?php echo $spkId; ?>">
                                <?php
                                include "koneksi.php";
                                $sql = "SELECT 
                                        ...
                                        <div class="card-body p-2">
                                            <div class="row p-1">
                                                ...
                                                <div class="col-sm-1 mb-2">
                                                    ...
                                                    <input type="hidden" name="id_tmp_ecat[]" value="' . $row["id_tmp_ecat"] . '">
                                                </div>
                                                <div class="col-sm-1 mb-2 text-center">
                                                    <button type="submit" class="btn btn-danger btn-sm delete-data" data-id="' . $row["id_tmp_ecat"] . '"><i class="bi bi-trash"></i></button>
                                                </div>
                                            </div>
                                        </div>';
                                        $counter++;
    ...
    <script>
        function cetakSPK() {
            // Mendapatkan id_spk_ecat dari URL
            var id_spk_ecat = "<?php echo isset($_GET['id_spk_ecat']) ? $_GET['id_spk_ecat'] : ''; ?>";
            // Redirect ke halaman cetak_spk_ecat.php dengan menyertakan id_spk_ecat
            window.location.href = "cetak_spk_ecat.php?id_spk_ecat=" + id_spk_ecat;
        }
    </script>
    <script>
    ...
    <div class="modal fade" id="modalCenter" tabindex="-1" aria-labelledby="modalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalEditTitle">Edit Details Data</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                        ...
                        <div class="mb-3 mt-2">
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                    ...
                                    <input type="date" id="atasNama" name="atas_nama" class="form-control" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label"><strong>Pilih Sales</strong></label>
                                <select class="form-select" id="id_sales_select" name="id_sales_select" required>
                                    <option value="">Pilih Sales</option>
                                    <?php
                                    include "koneksi.php";
                                    $query_sales = "SELECT * FROM tb_sales_ecat";
                                    $result_sales = mysqli_query($koneksi, $query_sales);
                                    while ($data_sales = mysqli_fetch_array($result_sales)) {
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                    <label class="form-label">Sales Marketing</label>
                                    <input type="text" id="atasNama" name="atas_nama" class="form-control" required>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form id="deleteForm" method="post" action="proses/aksi_spk_ecat.php">
                    <input type="hidden" name="id_spk_ecat" value="<?php echo $id_spk_ecat; ?>">
                    <input type="hidden" name="id_tmp_ecat" value="<?php echo $id_tmp_ecat; ?>">
                    ...
                    <div class="modal-body">
                        <input type="hidden" name="id_tmp_ecat" id="idToDelete">
      ...
      <div class="modal-body">
        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-set" role="tabpanel" aria-labelledby="pills-set-tab">
                <div class="table-responsive">
                    <table class="table table-striped" id="ecat_modal_set">
                        <thead>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center text-nowrap">
                                        ...
                                        ?>
                                        <button class="btn-pilih btn btn-primary btn-sm" data-id="<?php echo $id_produk; ?>" data-spk="<?php echo $spkId; ?>" <?php echo ($isChecked || $isDisabled) ? 'disabled' : ''; echo $hidden_attribute; ?>>Pilih</button>
                                    </td>
                                </tr>
                                <?php $no++; ?>
                            <?php } ?>
            ...
            <div class="tab-pane fade" id="pills-satuan" role="tabpanel" aria-labelledby="pills-satuan-tab">
                <div class="table-responsive">
                    <table class="table table-striped" id="ecat_modal_satuan">
                        <thead>
                            <tr class="text-white" style="background-color: #051683;">
                                <th class="text-center p-3" style="width: 5%; color: #ffffff;">No</th>
                                <th class="text-center p-3" style="width: 40%; color: #ffffff;">Nama Produk</th>
...
<script type="text/javascript">
    new DataTable('#ecat_modal_set');
</script>
<script type="text/javascript">
    new DataTable('#ecat_modal_satuan');
</script>
<script>
  $(document).ready(function() {
    ...
    function displayProducts(page) {
      ...
      $.each(displayedProducts, function(index, product) {
        var row = '<tr>' +
                    ...
                    '<td class="text-center text-nowrap">' +
                      '<button class="btn-pilih btn btn-primary btn-sm" data-id="' + product.id_produk + '" data-spk="' + product.spkId + '">Pilih</button>' +
                    '</td>' +
                  '</tr>';
...
<div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEditTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="proses/aksi_spk_ecat.php" method="POST">
                <div class="modal-body">
                    <div class="mb-3 mt-2">
                        <input type="hidden" id="id_tmp_ecat" name="id_tmp_ecat" class="form-control" value="<?php echo $row['id_tmp_ecat']; ?>" required>
                        <div class="row">
                            <div class="col mb-3">
