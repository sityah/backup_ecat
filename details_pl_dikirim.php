...
<body>
                                        ...
                                        <div class="row mb-4">
                                            <div class="table-responsive">
                                                <div class="d-flex justify-content-between mb-3">
                                                    <div class="">
                                                        <button type="button" class="btn btn-primary" onclick="window.location.href = 'spk_pl_dikirim.php';">
                                                        ...
                                                        <?php
                                                            ...
                                                            $query_jenis_pengiriman = "SELECT jenis_pengiriman FROM status_kirim WHERE id_inv_ecat = '$id_inv_pl'";
                                                    ...
                                                    <div class="modal fade" id="editNamaPetugasModal" tabindex="-1" aria-labelledby="inputNamaPetugasModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <form id="inputNamaDriverForm" method="post" action="proses/ubah_driver_pl.php">
                                                                    <input type="hidden" id="id_inv_ecat" name="id_inv_ecat" value="<?php echo $id_inv_pl; ?>">
                                                    ...
                                                    <div class="modal fade" id="ubahJenisPengirimanModal" tabindex="-1" aria-labelledby="ubahJenisPengirimanLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <form id="inputNamaPetugasForm" method="post" action="proses/ubah_jenis_pengiriman_pl.php">
                                                                    <input type="hidden" id="id_inv_ecat" name="id_inv_ecat" value="<?php echo $id_inv_pl; ?>">
                                                                    <input type="hidden" class="form-control" name="id_status_kirim">
                                                                    <div class="modal-body">
                                                                        <div class="mb-3">
                                                    ...
                                                    <?php
                                                        ...
                                                        if ($result_total && mysqli_num_rows($result_total) > 0 && $result_fee_marketing && mysqli_num_rows($result_fee_marketing) > 0) {
                                                            ...
                                                            echo "                <h3 class='card-title mb-2'>" . number_format($total_inv_pl) . "</h3>";
                                                            echo "            </div>";
                                                            echo "        </div>";
                                                            echo "    </div>";
                                                            echo "</div>";
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="inputResidanOngkirForm" method="post" action="proses/proses_resi_ongkir_pl.php"  enctype="multipart/form-data">
                <div class="modal-body">
                    <input type="hidden" id="id_inv_ecat" name="id_inv_ecat" value="<?php echo $id_inv_pl; ?>">
                    <div class="mb-3">
