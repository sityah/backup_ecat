                                ...
                                <div class="card-body border mt-2 mb-4">
                                    <div class="row mb-4">
                                        <div class="table-responsive">
                                            <button type="button" class="btn btn-primary mb-3" onclick="window.location.href = 'spk_pl_dalam_proses.php';"><i class="tf-icons bx bxs-chevrons-left"></i> Kembali</button>
                                            <button type="button" class="btn btn-outline-primary mb-3" id="btnProsesPesanan" data-spkid="<?php echo $id_spk_pl; ?>" data-bs-toggle="modal" data-bs-target="#konfirmasiModal">
                                            ...
                                            <div class="modal fade" id="inputNamaPetugasModal" tabindex="-1" aria-labelledby="inputNamaPetugasModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <form id="inputNamaPetugasForm" method="post" action="proses/update_nama_petugas_pl.php">
                                                            <input type="hidden" name="spkId" value="<?php echo $id_spk_pl; ?>">
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        $query = "SELECT 
                                                                ...
                                                                WHERE 
                                                                    sr.id_spk_pl = '$id_spk_pl' AND sr.status_spk_pl = 'Dalam Proses'";
                                                        ...
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                            ...
                                                            echo "<td>" . $row['qty'] . "</td>"; 
                                                            echo "<td>
                                                                    <button type='button' class='btn btn-danger btn-sm mt-2 btn-delete' data-id='" . $row['id_transaksi_pl'] . "' data-nama='" . $row['nama_produk'] . "'>
