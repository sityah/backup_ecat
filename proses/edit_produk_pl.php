    ...
    <?php
        ...
        if (isset($_POST["edit-produk"])) {
            ...
            if ($update) {
                ...
                $query_total_harga = "SELECT SUM(total_harga) AS total_harga FROM transaksi_produk_pl WHERE id_transaksi_pl = '$id_transaksi_pl'";
                ...
                $update_total_spk_pl = mysqli_query($koneksi, "UPDATE tb_spk_pl SET total_spk_pl = '$total_harga_pl' WHERE id_inv_pl = '$id_inv_pl'");
