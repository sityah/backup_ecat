...
<?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $query = "UPDATE status_kirim SET jenis_pengiriman = '$jenis_pengiriman', id_driver = '$id_driver', id_ekspedisi = '$id_ekspedisi', dikirim_oleh = '$dikirim_oleh', penanggung_jawab = '$penanggung_jawab', tgl_kirim = '$tgl_kirim' WHERE id_inv_ecat = '$id_inv_pl'";
            ...
            if (mysqli_query($koneksi, $query)) {
                ...
                echo '<script>
                        Swal.fire({
                            ...
                            window.location.href = "../details_pl_dikirim.php?id_inv_pl=' . $id_inv_pl . '";
                        });
                    </script>';
            } else {
