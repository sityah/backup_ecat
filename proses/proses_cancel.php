    ...
    <?php
        ...
        if(isset($_POST['delete-spk'])) {
            ...
            while($row = mysqli_fetch_assoc($result_select_trans)) {
                ...
                $query_insert_cancel = "INSERT INTO trx_cancel (id_trx_cancel, id_spk_ecat, id_produk, qty, harga, disc, total_harga, created_date) VALUES ('$idTrxCancel', '$id_spk_ecat', '$id_produk', '$qty', '$harga', '$disc', '$total_harga', '$created_date')";
            ...
            $query_delete_trans = "DELETE FROM transaksi_produk_ecat WHERE id_spk = '$id_spk_ecat'";
