...
<body>
    <?php
        ...
        if (isset($_POST["delete-produk"])) {
            ...
            if(isset($_POST['id_transaksi_pl']) && isset($_POST['nama_produk'])) {
                ...
                $delete = mysqli_query($koneksi, "DELETE FROM transaksi_produk_pl WHERE id_transaksi_pl = '$id_transaksi_pl'");
                ...
                if ($delete) {
                    ...
                    echo '<script>
                                Swal.fire({
                                    ...
                                    window.location.href = "../detail_produk_spk_pl_dalam_proses.php?id_spk_pl=' . $data_lama['id_spk'] . '";
                                });
                            </script>';
                } else {
