                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <div class="card mb-4 p-2">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="col-6 col-md-2 mt-3 ms-1 d-flex align-items-center">
                                    <div class="demo-inline-spacing">
                                        <div class="badge bg-label-dark">
                                            <p class="mb-3 mt-2 text-start"><b>No. PO :</b> 001/PO/XI/2023</p>
                                            <p class="mb-2 text-start"><b>Tgl. PO :</b> 12 December 2023</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-4 me-3">
