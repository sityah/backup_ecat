                            ...
                            <div class="row mb-4">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-select" id="jenisSelect">
                                    ...
                                    <!-- Filter Status Paket -->
                                    <div class="col-md-2">
                                        <label>Filter Status Paket :</label>
                                ...
                                <div class="col-lg-2 col-md-2 order-2">
                                    <div class="card">
                                        <div class="card-body d-flex align-items-center justify-content-center">
                                            <div class="text-center">
                                ...
                                <div class="col-lg-2 col-md-2 order-4">
                                    <div class="card">
                                        <div class="card-body d-flex align-items-center justify-content-center">
                                            <div class="text-center">
                                ...
                                <div class="col-lg-2 col-md-2 order-5">
                                    <div class="card">
                                        <div class="card-body d-flex align-items-center justify-content-center">
                                            <div class="text-center">
                                ...
                                <div class="col-lg-2 col-md-2 order-6">
                                    <div class="card">
                                        <div class="card-body d-flex align-items-center justify-content-center">
                                            <div class="text-center">
