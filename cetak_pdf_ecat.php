...
<body>
    <div class="container flex-container">
        ...
        <!-- <div style="display: inline-block; margin-top: 10px; margin-right: 20px;">
            <table style="border-collapse: collapse; width: 100%; border: none; max-width: 200px;">
                <thead>
                    <tr>
                        <th scope="col" style="text-align: left; border: none; vertical-align: top;">Disetujui oleh,</th>
                    </tr>
                </thead>
                <tbody>
                    <td style="text-align: left; height: 90px; border: none;">(____________)</td>
                </tbody>
            </table>
        </div>
        <div style="display: inline-block; margin-top: 10px; margin-right: 20px;">
        ...
        <div style="display: inline-block; margin-top: 10px; margin-right: 20px;">
            <table style="border-collapse: collapse; width: 100%; border: none; max-width: 200px;">
                <thead>
                    <tr>
                        <th scope="col" style="text-align: left; border: none; vertical-align: top;">Metode Pembayaran:</th>
                    </tr>
                </thead>
                <tbody>
                    <td style="text-align: left; height: 90px; border: none;">(____________)</td>
...
<?php
    ...
    $pdfFilePath = "invoices/invoice_$id_inv_ecat.pdf"; // Path untuk menyimpan file PDF
