                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary"><strong>WELCOME TO E-CATALOGUE</strong></h5>
                          <p class="mb-4">
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-semibold d-block mb-1">Total Cancel TS</span>
                  ...
                  <div class="card">
                    <div class="row row-bordered g-0">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="d-flex px-fluid-4 px-lg-2 p-4 gap-fluid-3 gap-lg-1 gap-3 justify-content-between">
                          <div class="d-flex">
                            <div class="me-2">
                  ...
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                      <div class="card-title mb-0">
                        <h5 class="m-0 me-2">Total Fee Marketing</h5>
