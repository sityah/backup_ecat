...
<body>
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card mb-4 p-2">
                            <h5 class="card-header text-center"><b>DETAIL PRODUK SPK PENUNJUKKAN LANGSUNG</b></h5>
                            ...
                            <form id="insertForm" method="post" action="proses/update_nama_petugas_pl.php">
                                <input type="hidden" name="id_spk_pl" value="<?php echo $id_spk_pl; ?>">
                                <div class="card-body border mt-2 mb-4">
                                    <div class="row mb-4">
                                        <div class="table-responsive">
                                            <div class="d-flex justify-content-between mb-3">
                                                <button type="button" class="btn btn-primary" onclick="window.location.href = 'spk_pl_siap_kirim.php';"><i class="tf-icons bx bxs-chevrons-left"></i> Kembali</button>
                                                <?php
                                                    // Mengambil nama petugas dari tb_spk_pl
                                                    include "koneksi.php";
                                                    $query_petugas = "SELECT petugas_pl FROM tb_spk_pl WHERE id_spk_pl = '$id_spk_pl'";
                                                    $result_petugas = mysqli_query($koneksi, $query_petugas);
                                                    $row_petugas = mysqli_fetch_assoc($result_petugas);
                                                    $nama_petugas = $row_petugas['petugas_pl'];
                                            ...
                                            <table class="table table-striped" id="selectedProductsTable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col" style="width: 18%;">Total Harga</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                        ...
                                                        $query = "SELECT 
                                                                ...
                                                                WHERE 
                                                                    sr.id_spk_pl = '$id_spk_pl' AND tps.status_trx = 0";
    ...
    <?php
        ...
        // Ambil id_spk_pl dari URL
        $id_spk_pl = $_GET['id_spk_pl'];

        // Buat query SQL untuk mengambil data lama dari database
        $query_select = "SELECT * FROM tb_spk_pl WHERE id_spk_pl = '$id_spk_pl'";
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" aria-labelledby="modalEditTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="proses/edit_details_pl.php" method="POST">
                    <input type="hidden" name="id_spk_pl" value="<?php echo $id_spk_pl; ?>">
                        ...
                        <div class="mb-3 mt-2">
                            <div class="row">
                                <div class="col mb-3">
                                    ...
                                    <input type="date" id="tgl_spk_pl" name="tgl_spk_pl" class="form-control" value="<?php echo $tgl_spk_pl; ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col mb-3">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form id="deleteForm" method="post" action="proses/pl_dalam_proses.php">
                    <div class="modal-header">
