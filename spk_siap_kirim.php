                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="navs-pills-top-home" role="tabpanel">
                            <ul class="nav nav-tabs nav-fill" role="tablist">
                                ...
                                <li class="nav-item">
                                    <button type="button" class="nav-link" data-bs-toggle="tab" data-bs-target="#navs-justified-messages">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            buatInvoiceButton.addEventListener('click', () => {
                ...
                const idSpkEcat = checkboxes[0].value;

                window.location.href = `form_invoice_ecat.php?id_spk_ecat=${idSpkEcat}`;
            });
        });
    </script>
