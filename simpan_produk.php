...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['id_spk']) && isset($_POST['id_produk'])) {
        ...
        $query_insert = "INSERT INTO tmp_produk_spk_ecat (id_tmp_ecat, id_spk_ecat, id_produk_ecat, qty) VALUES ('$uuid', '$id_spk_ecat', '$id_produk_ecat', '0')";
    ...
    if (isset($_POST['id_tmp_ecat'])) {
        $id_tmp_ecat = $_POST['id_tmp_ecat'];

        $query_delete = "DELETE FROM tmp_produk_spk_ecat WHERE id_tmp_ecat = '$id_tmp_ecat'";
